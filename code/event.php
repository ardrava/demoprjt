...
.submit-btn input:hover {
  ...
  <form method="POST" action="regprocess.php">
      ...
      <div class="form-group rfullname">
        <label for="rfullname">Event_name</label>
        <input type="text" id="rfullname" placeholder="Enter event name">
      </div>
      <div class="form-group rmail">
        <label for="rmail">Details</label>
        <input type="text" id="rmail" placeholder="Enter event details">
      </div>
      <div class="form-group rmail">
        <label for="rmail">Venue</label>
        <input type="text" id="rmail" placeholder="Enter venue">
      </div>
      <div class="form-group rdob">
        <label for="rdob">Date</label>
        <input type="date" id="rdob" placeholder="Select event date">
      </div>
